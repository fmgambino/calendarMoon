        ...
        <div class="modal" id="ventana"  tabindex="-1" role="dialog" aria-labelledby="tituloVentana" arial-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <button type="button" class="btn btn-primary btn-lg" data-target="#calendario" data-toggle="modal" >Aggiungi nuovo</button>
                    <br><br>
                    <button type="button" class="btn btn-primary btn-lg" data-target="#ventanaEditar" data-toggle="modal" >modificare</button>
                    </div>
                    <button style="width:30%;margin-left:35%" class="btn btn-warning" type="button" data-dismiss="modal">Chiudere</button>
        ...
        <div class="modal" id="ventana1"  tabindex="-1" role="dialog" aria-labelledby="tituloVentana" arial-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                    <button type="button" class="btn btn-primary btn-lg" data-target="#topday" data-toggle="modal" >Aggiungi nuovo</button>
                    <br><br>
                    <button Style="border:none;margin:none;margin-left: -1%;"><a class="btn btn-primary btn-lg" href="modificarTopday.php">modificare</a></button>
                    </div>
                    <button style="width:30%;margin-left:35%" class="btn btn-warning" type="button" data-dismiss="modal">Chiudere</button>
                    <div class="modal-footer">
                    </div>
        ...
        <div class="modal" id="ventana2"  tabindex="-1" role="dialog" aria-labelledby="tituloVentana" arial-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                    <button type="button" class="btn btn-primary btn-lg" data-target="#glosario" data-toggle="modal" >Aggiungi nuovo</button>
                    <br><br>
                    <button Style="border:none;margin:none;margin-left: -1%;"><a class="btn btn-primary btn-lg" href="modificarGosario.php">modificare</a></button>
                    </div>
                    <button style="width:30%;margin-left:35%" class="btn btn-warning" type="button" data-dismiss="modal">Chiudere</button>
                    <div class="modal-footer">
                    </div>
