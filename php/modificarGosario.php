                ...
                <div class="modal-content">
                   <div class="modal-header">
                    ...
                    <?php                    
                        ...
                        $Consulta = " SELECT * FROM glosario ";
                        $result = mysqli_query($Conexion, $Consulta);    
                        while ($fila = mysqli_fetch_array($result)){ 
                            echo '
                            
                            <div class="modal-body form-inline">
                                <button data-target="#glosario'.$fila['id'].'" data-toggle="modal" class="botontopday col-9">'.$fila['text1'].
                                  '<img src="'.$fila['imagen'].'" alt="" style="width: 25%;;height: 100%;float:right;">
                                </button>
                                
                                <a href="delete.php?tabla=glosario&id='.$fila['id'].'" class="btn btn-light mb-0 ml-1 col-2">
