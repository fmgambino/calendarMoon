...
<body>
        ...
        <div class="abs-center">
            <form  action="php/validar.php" method="get" class="p-5 form">
                <div class="form-group">
                       ...
                       <button type="button" class="btn btn-secondary btn-lg" data-toggle="modal" data-target="#ventanaModal1">Admin</button>
    ...
    <main class="container">
        <div class="modal" id="ventanaModal"  tabindex="-1" role="dialog" aria-labelledby="tituloVentana" arial-hidden="true">  
                        ...
                        <form  action="php/registrar.php" method="get" >
                            <div class="form-group">
                                <h6 class="h3 text-black">Nome e Cognome</h6>
                                    <input type="text" name="nome" formControlName="usuario" class="form-control text-center" require>
                                <h6 class="h3 text-black">Utente</h6>
                                    <input type="text" name="utente" formControlName="usuario" class="form-control text-center" require>
                                <h6 class="h3 text-black">Pasword</h6>
                                    <input type="password" name="pass" formControlName="pass" class="form-control text-center" require>
                                <h6 class="h3 text-black">Ripetere pasword</h6>
                                    <input type="password" name="pass1" formControlName="pass" class="form-control text-center" require>
                                    <h6 class="h3 text-black">Posta</h6>
                                    <input type="mail" name="mail" formControlName="pass" class="form-control text-center" require>
                            </div>
...
<!--modal registro exitoso-->
 <!--modal Ingreso de admin-->
    <main class="container">
        <div class="modal" id="ventanaModal1"  tabindex="-1" role="dialog" aria-labelledby="tituloVentana" arial-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
